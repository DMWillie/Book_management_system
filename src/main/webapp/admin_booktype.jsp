...
<%@ page import = "bean.TypeBean,dao.AdminDao,dao.TypeDao,dao.BookDao,bean.AdminBean" %>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            ...
                            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                <form class="form-horizontal" action="/books/AddBookTypeServlet" method="post">
                        
                                    <div class="col-lg-3 form-group">

                                        <button type="button" class="btn btn-primary" id="btn_add" data-toggle="modal" data-target="#addBookType">添加分类</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                            ...
                            <!---在此插入信息-->
                             <%
                             ArrayList<TypeBean> typedata = new ArrayList<TypeBean>();
//                             typedata = (ArrayList<TypeBean>)request.getAttribute("data");
//                           if(typedata==null){
                             TypeDao bookdao = new TypeDao();
                             typedata = (ArrayList<TypeBean>)bookdao.get_ListInfo();
//                           }
...
<button type="button" class="btn btn-danger btn-xs" onclick="deletebookType(<%= bean.getTid() %>)">删除</button>
	</td>                                            
                          	  </tbody>
                       <%} %> 
                        </table>
    ...
    function deletebookType(tid) {
     ...
     <!--------------------------------------添加的模糊框------------------------>  
                                 <form class="form-horizontal" method="post" action="/books/AddBookTypeServlet">   <!--保证样式水平不混乱-->   
                                        <!-- 模态框（Modal） -->
									<div class="modal fade" id="addBookType" tabindex="-1" role="dialog" aria-labelledby="addBookTypeLabel" aria-hidden="true">
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													<button type="button" class="close" data-dismiss="modal" aria-hidden="true">
													...
													<h4 class="modal-title" id="addBookTypeLabel">
														添加新图书分类
													</h4>
												</div>
												<div class="modal-body">
