                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            ...
                            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                <form class="form-horizontal" action="/books/AddUserServlet" method="post">
                        
                                    <div class="col-lg-3 form-group">

                                        <button type="button" class="btn btn-primary" id="btn_add" data-toggle="modal" data-target="#addUserModal">添加读者</button>
                                    </div>
                                </form>
                            </div>
                        </div>
                               ...
                               <form class="form-horizontal" method="post" action="/books/updateUserServlet">   <!--保证样式水平不混乱-->   
									<div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="updateModalLabel" aria-hidden="true">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">当前借阅数</label>
												<div class="col-sm-7">
													<input type="hidden" id="updateaid" name="aid">
													<input type="text" class="form-control" id="updatelend_num" name="lend_num"  placeholder="请输入当前借阅数">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">最大借阅数</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="updatemax_num" name="max_num"  placeholder="请输入最大借阅数">
												<label class="control-label" for="updatePress" style="display: none;"></label>
												</div>
										</div>	
										</div>
                                 ...
                                 <form class="form-horizontal" method="post" action="/books/AddUserServlet">   <!--保证样式水平不混乱-->   
									...
									<div class="modal fade" id="addUserModal" tabindex="-1" role="dialog" aria-labelledby="addUserLabel" aria-hidden="true">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">当前借阅数</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" name="lend_num" id="addlendNum" required="required"  placeholder="请输入可借阅天数">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">最大可借数</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" name="max_num" id="addMaxnum" required="required" placeholder="请输入最大可借数">
