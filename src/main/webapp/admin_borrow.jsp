...
<%@ page import = "bean.HistoryBean,dao.AdminDao,dao.HistoryDao,dao.BookDao,bean.AdminBean" %>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                            ...
                            <!---在此插入信息-->
                             <%
                             ArrayList<HistoryBean> borrowdata = new ArrayList<HistoryBean>();
//                           borrowdata = (ArrayList<HistoryBean>)request.getAttribute("data");
//                           if(borrowdata==null){
                             HistoryDao historyDao = new HistoryDao();
                             borrowdata = (ArrayList<HistoryBean>)historyDao.get_HistoryListInfo2(1);
//                           }
  for (HistoryBean bean : borrowdata){
  %>                 
                            	<tbody>
	                         	   	<td><%= bean.getCard() %></td>
