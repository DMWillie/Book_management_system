...
<%@ page import = "bean.AdminBean,bean.HistoryBean,dao.BookDao,dao.AdminDao" %>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="collapse navbar-collapse main-navbar-collapse">
                    <a class="navbar-brand" href="/reader.js"><strong>欢迎使用图书馆管理系统</strong></a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                            ...
                            <%
                             ArrayList<HistoryBean> historydata = new ArrayList<>();
                             HistoryDao historyDao = new HistoryDao();
                             historydata= (ArrayList<HistoryBean>)historyDao.get_HistoryListInfo(1,aid);
...
<button type="button" class="btn btn-info btn-xs" data-toggle="modal" onclick="haibook(<%= bean.getHid() %>)">还书</button>
    ...
    function haibook(hid) {
    	con=confirm("是否还书?"); 
    	if(con==true){
    		location.href = "/books/borrowServlet?tip=2&hid="+hid;
    	}
    }
    </script>
        </div>
