...
<%@ page import = "bean.TypeBean,dao.AdminDao,dao.TypeDao,bean.BookBean,dao.BookDao,bean.AdminBean" %>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="collapse navbar-collapse main-navbar-collapse">
                        <a class="navbar-brand"><strong>欢迎使用图书馆管理系统</strong></a>
        ...
        <div class="row">
            ...
            <div class="col-md-2 bootstrap-admin-col-left">
                <ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
					...
					<li>
						<a href="/books/admin_review.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 图书借阅管理</a>
					</li>
                    <li>
                            ...
                            <div class="bootstrap-admin-no-table-panel-content bootstrap-admin-panel-content collapse in">
                                ...
                                <input type="hidden" name="tip" value="1">	<!--tip=1表示管理员查询页面-->
                        			<div class="col-lg-8 form-group">
                                        <label class="col-lg-3 control-label" for="queryByname">图书名称</label>
                                        <div class="col-lg-4">
                                            <input class="form-control" id="bookName" name="name" type="text" placeholder="请输入图书名称">
                                            <label class="control-label" for="queryByname" style="display: none;"></label>
                                        </div>
                                        <label class="col-lg-2 control-label" for="queryBycard">图书号</label>
                                        <div class="col-lg-3">
                                            <input class="form-control" id="bookCard" name="card" type="text" placeholder="请输入图书号">
...
ArrayList<TypeBean> data = (ArrayList<TypeBean>)typedao.get_ListInfo();
  ...
  %>                 <option value="<%= bean.getName() %>"><%= bean.getName() %></option>                        <%} %>                                        
                                        ...
                                        <div class="form-group">
                                             <label for="firstname" class="col-sm-3 control-label">借用人</label>
                                                  <div class="col-sm-7">
                                                      <input type="text" class="form-control" id="updateBorrowUser" name="borrowUser"  placeholder="请输入借用人">
                                                      <label class="control-label" for="updateBorrowUser" style="display: none;"></label>
                                                  </div>
                                         </div>
                                        <div class="form-group">
                                            <label for="firstname" class="col-sm-3 control-label">借用日期</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="updateBorrowTime" name="borrowTime"  placeholder="请输入借用日期,如2020-01-01">
  ...
  %>                 <option value="<%= bean.getName() %>"><%= bean.getName() %></option>                        <%} %>
                                        ...
                                        <div class="form-group">
                                            <label for="firstname" class="col-sm-3 control-label">借用人</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="addBorrowUser" required="required" name="borrowUser" placeholder="请输入借用人">
                                        ...
                                        <div class="form-group">
                                            <label for="firstname" class="col-sm-3 control-label">借用日期</label>
                                            <div class="col-sm-7">
                                                <input type="text" class="form-control" id="addBorrowTime" required="required" name="borrowTime" placeholder="请输入借用日期,如2020-01-01">
