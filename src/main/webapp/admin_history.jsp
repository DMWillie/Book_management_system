                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                            ...
                            <!---在此插入信息-->
                             <%
                             ArrayList<HistoryBean> historydata = new ArrayList<HistoryBean>();
//                           historydata = (ArrayList<HistoryBean>)request.getAttribute("data");
//                           if(historydata==null){
                             HistoryDao historyDao = new HistoryDao();
                             historydata = (ArrayList<HistoryBean>)historyDao.get_HistoryListInfo2(2);
//                           }
